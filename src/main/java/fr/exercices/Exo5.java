...
public class Exo5 {
    public final static HashMap<String, Integer> romansNumerals = new HashMap<>() {{
        put("M", 1000);
        put("D", 500);
        put("C", 100);
        put("L", 50);
     ...
     */
    private static void RomanNumberLessThan15Characters(String romanNumber) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException exception
     */
    private static void isItARomanNumber(String romanNumber) throws IllegalArgumentException {
     ...
     * @return String
     */
    private static String capitalizeRomanNumber(String romanNumber) {
     ...
     * @return int
     */
    public static int convertRomanNumIntoArabicNum(String romanNumber) {
